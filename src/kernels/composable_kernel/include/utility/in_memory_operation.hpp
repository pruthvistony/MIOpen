...
struct SetData
{
                                                                  ...
                                                                  index_t dst_range) const
    {
        ...
        amd_buffer_store<T, DataPerAccess>(
            src_valid ? &(p_src[src_offset]) : reinterpret_cast<const T*>(&zeros), p_dst, dst_offset, dst_valid, dst_range);
    }
#endif
};
...
struct AtomicAddData
{
                                                                  ...
                                                                  index_t dst_range) const
    {
        ...
        amd_buffer_atomic_add<T, DataPerAccess>(src_valid ? &(p_src[src_offset]) : reinterpret_cast<const T*>(&zeros),
                                                p_dst,
                                                dst_offset,
                                                dst_valid,
                                                index_t dst_range);
