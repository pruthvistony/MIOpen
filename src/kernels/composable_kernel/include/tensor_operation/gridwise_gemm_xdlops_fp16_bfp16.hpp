...
template <index_t GridSize,
          ...
          index_t ABlockCopySrcDataPerRead,
          index_t ABlockCopyDstDataPerWrite_KPACK,
          class BBlockCopyThreadSliceLengths_G_K_B_N1_KPack,
          class BBlockCopyThreadClusterLengths_G_K_B_N1_KPack,
          class BBlockCopyThreadClusterArrangeOrder,
          class BBlockCopySrcAccessOrder,
          class BBlockCopyDstAccessOrder,
          index_t BBlockCopySrcVectorReadDim,
...
struct GridwiseBatchGemmXdlops_gkmkpack_gknkpack_gmn_v2
{
                        ...
                        CFloat* const __restrict__ p_c_global) const
    {
        ...
        constexpr auto a_g_k_m_kpack_global_desc    = AGlobalDesc{};
        constexpr auto b_g_k_b_n1_kpack_global_desc = BGlobalDesc{};
        constexpr auto c_g_m_n_global_desc          = CGlobalDesc{};
        ...
        constexpr auto K     = b_g_k_b_n1_kpack_global_desc.GetLengths()[1];
        constexpr auto B     = b_g_k_b_n1_kpack_global_desc.GetLengths()[2];
        constexpr auto N1    = b_g_k_b_n1_kpack_global_desc.GetLengths()[3];
        constexpr auto KPack = b_g_k_b_n1_kpack_global_desc.GetLengths()[4];

        // divide block work by [M, N]
        static_assert(M % MPerBlock == 0 && B % NPerBlock == 0 && K % KPerBlock == 0,
                      "wrong! cannot divide work evenly among block");
        ...
        constexpr auto b_g_k_b_n1_kpack_block_desc = make_native_tensor_descriptor_aligned(
            Sequence<1, KPerBlock, NPerBlock, 1, KPack>{}, Number<max_align>{});

        // input blockwise copy
        auto b_blockwise_copy = BlockwiseGenericTensorSliceCopy_v4<
            BlockSize,
            decltype(b_g_k_b_n1_kpack_global_desc),
            decltype(b_g_k_b_n1_kpack_block_desc),
            decltype(b_g_k_b_n1_kpack_block_desc.GetLengths()),
            BBlockCopyThreadSliceLengths_G_K_B_N1_KPack,
            BBlockCopyThreadClusterLengths_G_K_B_N1_KPack,
            BBlockCopyThreadClusterArrangeOrder,
            BBlockCopySrcAccessOrder,
            BBlockCopyDstAccessOrder,
            BBlockCopySrcVectorReadDim, // Src dim to be read in vector form (B dimension)
            ...
            AddressSpace::Vgpr,
            AddressSpace::Lds,
            InMemoryDataOperation::Set>({g_block_data_on_global, 0, n_block_data_on_global, 0, 0},
                                        {0, 0, 0, 0, 0});
        ...
        constexpr index_t b_block_space =
            math::integer_least_multiple(b_g_k_b_n1_kpack_block_desc.GetElementSpace(), max_align);
